...
namespace TeamProjectIAN6.TaxService {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="urn:ec.europa.eu:taxud:vies:services:checkVat", ConfigurationName="TaxService.checkVatPortType")]
    public interface checkVatPortType {
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        TeamProjectIAN6.TaxService.checkVatResponse checkVat(TeamProjectIAN6.TaxService.checkVatRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<TeamProjectIAN6.TaxService.checkVatResponse> checkVatAsync(TeamProjectIAN6.TaxService.checkVatRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        TeamProjectIAN6.TaxService.checkVatApproxResponse checkVatApprox(TeamProjectIAN6.TaxService.checkVatApproxRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<TeamProjectIAN6.TaxService.checkVatApproxResponse> checkVatApproxAsync(TeamProjectIAN6.TaxService.checkVatApproxRequest request);
    }
    ...
    public partial class checkVatRequest {
        ...
        public TeamProjectIAN6.TaxService.checkVatRequestBody Body;
        
        public checkVatRequest() {
        }
        
        public checkVatRequest(TeamProjectIAN6.TaxService.checkVatRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class checkVatResponse {
        ...
        public TeamProjectIAN6.TaxService.checkVatResponseBody Body;
        
        public checkVatResponse() {
        }
        
        public checkVatResponse(TeamProjectIAN6.TaxService.checkVatResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class checkVatApproxRequest {
        ...
        public TeamProjectIAN6.TaxService.checkVatApproxRequestBody Body;
        
        public checkVatApproxRequest() {
        }
        
        public checkVatApproxRequest(TeamProjectIAN6.TaxService.checkVatApproxRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class checkVatApproxResponse {
        ...
        public TeamProjectIAN6.TaxService.checkVatApproxResponseBody Body;
        
        public checkVatApproxResponse() {
        }
        
        public checkVatApproxResponse(TeamProjectIAN6.TaxService.checkVatApproxResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class checkVatApproxResponseBody {
        ...
        public TeamProjectIAN6.TaxService.matchCode traderNameMatch;
        
        [System.Runtime.Serialization.DataMemberAttribute(Order=11)]
        public TeamProjectIAN6.TaxService.matchCode traderCompanyTypeMatch;
        
        [System.Runtime.Serialization.DataMemberAttribute(Order=12)]
        public TeamProjectIAN6.TaxService.matchCode traderStreetMatch;
        
        [System.Runtime.Serialization.DataMemberAttribute(Order=13)]
        public TeamProjectIAN6.TaxService.matchCode traderPostcodeMatch;
        
        [System.Runtime.Serialization.DataMemberAttribute(Order=14)]
        public TeamProjectIAN6.TaxService.matchCode traderCityMatch;
        ...
        public checkVatApproxResponseBody(
                    ...
                    string traderCity, 
                    TeamProjectIAN6.TaxService.matchCode traderNameMatch, 
                    TeamProjectIAN6.TaxService.matchCode traderCompanyTypeMatch, 
                    TeamProjectIAN6.TaxService.matchCode traderStreetMatch, 
                    TeamProjectIAN6.TaxService.matchCode traderPostcodeMatch, 
                    TeamProjectIAN6.TaxService.matchCode traderCityMatch, 
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface checkVatPortTypeChannel : TeamProjectIAN6.TaxService.checkVatPortType, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class checkVatPortTypeClient : System.ServiceModel.ClientBase<TeamProjectIAN6.TaxService.checkVatPortType>, TeamProjectIAN6.TaxService.checkVatPortType {
        ...
        TeamProjectIAN6.TaxService.checkVatResponse TeamProjectIAN6.TaxService.checkVatPortType.checkVat(TeamProjectIAN6.TaxService.checkVatRequest request) {
        ...
        public string checkVat(ref string countryCode, ref string vatNumber, out bool valid, out string name, out string address) {
            TeamProjectIAN6.TaxService.checkVatRequest inValue = new TeamProjectIAN6.TaxService.checkVatRequest();
            inValue.Body = new TeamProjectIAN6.TaxService.checkVatRequestBody();
            inValue.Body.countryCode = countryCode;
            inValue.Body.vatNumber = vatNumber;
            TeamProjectIAN6.TaxService.checkVatResponse retVal = ((TeamProjectIAN6.TaxService.checkVatPortType)(this)).checkVat(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<TeamProjectIAN6.TaxService.checkVatResponse> TeamProjectIAN6.TaxService.checkVatPortType.checkVatAsync(TeamProjectIAN6.TaxService.checkVatRequest request) {
            return base.Channel.checkVatAsync(request);
        }
        
        public System.Threading.Tasks.Task<TeamProjectIAN6.TaxService.checkVatResponse> checkVatAsync(string countryCode, string vatNumber) {
            TeamProjectIAN6.TaxService.checkVatRequest inValue = new TeamProjectIAN6.TaxService.checkVatRequest();
            inValue.Body = new TeamProjectIAN6.TaxService.checkVatRequestBody();
            inValue.Body.countryCode = countryCode;
            inValue.Body.vatNumber = vatNumber;
            return ((TeamProjectIAN6.TaxService.checkVatPortType)(this)).checkVatAsync(inValue);
        }
